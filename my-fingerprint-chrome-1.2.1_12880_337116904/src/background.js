...
const init = async function (prevVersion) {
  ...
  data[Mode.basic] = Object.assign({
    ...
    [Item.orientation]: {select: 0, value: Opt.default},
    [Item.userAgentData]: {select: 0, value: Opt.default},
    [Item.hid]: {select: 0, value: Opt.default},
    ...
    [Item.pdfViewerEnabled]: {select: 0, value: Opt.default},
  }, data[Mode.basic])
  // spacial
