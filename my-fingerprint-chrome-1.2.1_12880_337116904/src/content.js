...
const init = async function () {
  ...
  Object.assign(navigatorValues, {
    ...
    [BasicConf.pdfViewerEnabled]: getBasicValue(bData[BasicConf.pdfViewerEnabled], randomPdfViewerEnabled),
    [BasicConf.userAgentData]: getBasicValue(bData[BasicConf.userAgentData], randomUserAgentData),
    [BasicConf.hid]: getBasicValue(bData[BasicConf.hid], randomHid),


  })

  Object.assign(screenValues, {
    [BasicConf.orientation]: getBasicValue(bData[BasicConf.orientation], randomOrientation),
