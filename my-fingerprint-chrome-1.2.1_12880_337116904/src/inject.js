    ...
    if (isRestore) {
      ...
      let get = function (target, key) {
        ...
        switch (key) {
          ...
          case 'pdfViewerEnabled': id = Opt.pdfViewerEnabled; break;
          case 'userAgentData': id = Opt.userAgentData; break;
          case 'hid': id = Opt.hid; break;
        }
        if (id != null) {
          recordAndSend(id)
    ...
    if (isRestore) {
      ...
      let get = function (target, key) {
        ...
        switch (key) {
          ...
          case 'orientation': id = Opt.orientation; break;
        }
        if (id != null) {
          recordAndSend(id)
